 ...
 * (use if else) if any other alphabet should be invalid
 * entry USING SWITCH STATEMENT
 */
public class Programmer_9_PrintCityNameWithSwitch {
    ...
    public static void main(String[] args) {
        ...
        Programmer_9_PrintCityNameWithSwitch cityName = new Programmer_9_PrintCityNameWithSwitch();
